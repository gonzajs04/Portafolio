...
$proyectos = [
    (new Proyecto("Almas fortalecidas piedras", "PROYECTO 2", "Este es mi primer proyecto de todos, en el cual solamente utilice HTML y CSS | This is my first project. I used only HTML and CSS", "https://almaspiedrasfortalecidas.netlify.app/")),
    (new Proyecto("El Granizado", "Proyecto 1", "Este es mi segundo proyecto. Ya con mas practica, empece a jugar un poco con HTML y CSS. | This is my second project, with more practice, I started to play a little bit with HTML and CSS", "https://elgranizado.netlify.app/")),
        ...
        <div class="contenedorg-sobremi">
            <div class="contenedor-sobremi">
                <div class="contenedor grid-sobremi">
                    ...
                    <div class="sobremi-texto" data-aos="fade-left">
            ...
            <?php foreach ($proyectos as $proyecto) { ?>
                ...
                <div class="proyecto">
                    <div class="img-proyecto">
                        ...
                        <img src="/build/img/<?php echo $proyecto->getImagen() . ".png"; ?>" alt="Imagen Proyecto">
