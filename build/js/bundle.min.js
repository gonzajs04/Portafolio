function iniciarApp(){const e=document.querySelector(".toggle"),t=document.querySelector(".navegacion");function a(){const e=document.getElementById("enviar-correo");null!=e&&e.addEventListener("click",e=>{e.preventDefault();const t=document.querySelector(".form-email").value,a=document.querySelector(".form-nombre").value,i=document.querySelector(".form-descripcion").value;if(""!=t&&""!=a)return window.location.href=`mailto:hernandezgonzalo5845@gmail.com?subject=Contactoparapropuesta&body=Nombre%3A${a}%0AApellido%3A%20%0AMail%3A${t}%0AMensaje%3A${i}`,void(window.location.href="/")})}null!=e&&(e.addEventListener("click",()=>{t.classList.add("visible"),e.classList.add("novisible")}),a());const i=document.querySelector(".close");null!=i&&i.addEventListener("click",()=>{t.classList.remove("visible"),e.classList.remove("novisible")});document.querySelectorAll(".smooth").forEach(e=>{e.addEventListener("click",e=>{e.preventDefault();const t=e.target.attributes.href.value;document.querySelector(t).scrollIntoView({behavior:"smooth"})})});const n=document.querySelector(".btn-enviar");null!=n&&n.addEventListener("click",e=>{e.preventDefault(),a()});document.querySelector(".btn-dark").addEventListener("click",e=>{activarDark(e)}),recorrerProyectos()}function recorrerProyectos(){const e=document.querySelectorAll(".proyecto");null!=e&&e.forEach(e=>{desplegarDescripcion(e)})}function desplegarDescripcion(e){const t=e.querySelector(".texto-proyecto"),a=e.querySelector(".container-descripcionbtn button");a.addEventListener("click",()=>{"auto"==t.style.height?(t.style.height="100px",a.textContent="Ver Mas"):(t.style.height="auto",a.textContent="Ver Menos")})}function activarDark(e){const t=document.querySelector("body");"dark-mode"==t.className?t.classList.remove("dark-mode"):t.classList.add("dark-mode")}function enviarMail(e){e.preventDefault();const t=document.querySelector("#entidad"),a=t.options[t.selectedIndex].text,i=document.querySelector("#email").value,n=document.querySelector("#nombre").value,s=document.querySelector("#mensaje").value;window.location.href=`mailto:hernandezgonzalo5845@gmail.com?subject=envioDesdeFormulario&body=Nombre%3A%20${n}%0AEmail%3A%20${i}%0AMensaje%3A%20${s}%0AEntidad%3A%20${a}`}
